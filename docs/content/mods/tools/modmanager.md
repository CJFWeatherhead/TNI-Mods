...
# Tower Networking Inc - Mod Manager v3.7.2
...
**[[U+1F4E6] Download TNI-ModManager-v3.7.2.exe](https://github.com/CJFWeatherhead/TNI-Mods/releases/download/mod-manager-v3.7.2/TNI-ModManager-v3.7.2.exe)** *(Recommended)*
...
[View all releases on GitHub [U+2192]](https://github.com/CJFWeatherhead/TNI-Mods/releases/tag/mod-manager-v3.7.2)
