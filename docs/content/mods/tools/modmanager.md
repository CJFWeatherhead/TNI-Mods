...
**[[U+1F4E6] Download TNI-ModManager-v3.5.4.exe](https://github.com/CJFWeatherhead/TNI-Mods/releases/download/mod-manager-v3.5.4/TNI-ModManager-v3.5.4.exe)** *(Recommended)*
...
[View all releases on GitHub [U+2192]](https://github.com/CJFWeatherhead/TNI-Mods/releases/tag/mod-manager-v3.5.4)
