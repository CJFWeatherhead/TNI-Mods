...
| **[ModAPI Diagnostic Tool](/mods/modapi-diagnostic/)** | Comprehensive diagnostic, inspection, and API testing tool for TNI game engine. | `3.0.1` | CJFWeatherhead | 🟢 Active | <a href="https://github.com/CJFWeatherhead/TNI-Mods/releases/download/modapi-diagnostic-v3.0.1/modapi-diagnostic-3.0.1.zip" class="button inline">Download</a> |
