...
| **[All Proposals](/mods/all-proposals/)** | Shows all available proposals at once by overriding the game's proposal batch size. | `2.0.3` | CJFWeatherhead | 🟢 Active | <a href="https://github.com/CJFWeatherhead/TNI-Mods/releases/download/all-proposals-v2.0.3/all-proposals-2.0.3.zip" class="button inline">Download</a> |
