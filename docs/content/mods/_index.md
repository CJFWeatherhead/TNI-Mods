...
| **[Chaos Engine](/mods/chaos-engine/)** | A controlled chaos mod that introduces randomness and unpredictability to Tower Networking Inc | `0.1.3` | CJFWeatherhead | 🟢 Active | <a href="https://github.com/CJFWeatherhead/TNI-Mods/releases/download/chaos-engine-v0.1.3/chaos-engine-0.1.3.zip" class="button inline">Download</a> |
| **[Device Tweaker](/mods/device-tweaker/)** | A comprehensive mod for tweaking device properties in Tower Networking Inc. | `0.1.8` | CJFWeatherhead | 🟢 Active | <a href="https://github.com/CJFWeatherhead/TNI-Mods/releases/download/device-tweaker-v0.1.8/device-tweaker-0.1.8.zip" class="button inline">Download</a> |
...
| **[User Floor-Based Addressing](/mods/user-floor-addressing/)** | This mod sets DHCP mode, DNS servers, and assigns network addresses based on floor number and user increment. | `0.1.4` | CJFWeatherhead | 🟢 Active | <a href="https://github.com/CJFWeatherhead/TNI-Mods/releases/download/user-floor-addressing-v0.1.4/user-floor-addressing-0.1.4.zip" class="button inline">Download</a> |
