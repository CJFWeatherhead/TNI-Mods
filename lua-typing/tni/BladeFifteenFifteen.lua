...
local BladeFifteenFifteen = {}

function BladeFifteenFifteen.apply_autoconfig() end

---@param new_pos Vector2
function BladeFifteenFifteen.reposition(new_pos) end

---@param new_pos Vector2
function BladeFifteenFifteen.elevator_move(new_pos) end

---@return number
function BladeFifteenFifteen.get_device_bounding_height() end

---@return Vector2
function BladeFifteenFifteen.get_global_y_range() end

---@return Vector2
function BladeFifteenFifteen.get_local_y_range() end

---@return Object
function BladeFifteenFifteen.debug_monitor_callback() end

---@return Object
function BladeFifteenFifteen.debug_mux_setup() end

---@return Object
function BladeFifteenFifteen.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function BladeFifteenFifteen.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function BladeFifteenFifteen.drop(impulse) end

function BladeFifteenFifteen.reset_child_z_index() end

---@param new_state boolean
function BladeFifteenFifteen.set_autosvc(new_state) end

---@param new_value string
function BladeFifteenFifteen.update_user_note(new_value) end

function BladeFifteenFifteen.remove_and_free_object() end

function BladeFifteenFifteen.reset_child_z_index() end

---@param base_val integer
function BladeFifteenFifteen.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function BladeFifteenFifteen.get_picker_type(test_picker) end
...
---@param gpos Vector2
function BladeFifteenFifteen.setup_teleport(gpos) end
