...
function BladeThirty.apply_autoconfig() end

---@param new_pos Vector2
function BladeThirty.reposition(new_pos) end

---@param new_pos Vector2
function BladeThirty.elevator_move(new_pos) end

---@return number
function BladeThirty.get_device_bounding_height() end

---@return Vector2
function BladeThirty.get_global_y_range() end

---@return Vector2
function BladeThirty.get_local_y_range() end

---@return Object
function BladeThirty.debug_monitor_callback() end

---@return Object
function BladeThirty.debug_mux_setup() end

---@return Object
function BladeThirty.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function BladeThirty.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function BladeThirty.drop(impulse) end

function BladeThirty.reset_child_z_index() end

---@param new_state boolean
function BladeThirty.set_autosvc(new_state) end

---@param new_value string
function BladeThirty.update_user_note(new_value) end

function BladeThirty.remove_and_free_object() end

function BladeThirty.reset_child_z_index() end

---@param base_val integer
function BladeThirty.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function BladeThirty.get_picker_type(test_picker) end
...
---@param gpos Vector2
function BladeThirty.setup_teleport(gpos) end
