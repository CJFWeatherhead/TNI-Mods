...
function Firewatch.apply_autoconfig() end

---@param new_pos Vector2
function Firewatch.reposition(new_pos) end

---@param new_pos Vector2
function Firewatch.elevator_move(new_pos) end

---@return number
function Firewatch.get_device_bounding_height() end

---@return Vector2
function Firewatch.get_global_y_range() end

---@return Vector2
function Firewatch.get_local_y_range() end

---@return Object
function Firewatch.debug_monitor_callback() end

---@return Object
function Firewatch.debug_mux_setup() end

---@return Object
function Firewatch.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function Firewatch.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function Firewatch.drop(impulse) end

function Firewatch.reset_child_z_index() end

---@param new_state boolean
function Firewatch.set_autosvc(new_state) end

---@param new_value string
function Firewatch.update_user_note(new_value) end

function Firewatch.remove_and_free_object() end

function Firewatch.reset_child_z_index() end

---@param base_val integer
function Firewatch.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function Firewatch.get_picker_type(test_picker) end
...
---@param gpos Vector2
function Firewatch.setup_teleport(gpos) end
