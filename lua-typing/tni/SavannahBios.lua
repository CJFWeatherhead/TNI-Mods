...
function SavannahBios.apply_autoconfig() end

---@param new_pos Vector2
function SavannahBios.reposition(new_pos) end

---@param new_pos Vector2
function SavannahBios.elevator_move(new_pos) end

---@return number
function SavannahBios.get_device_bounding_height() end

---@return Vector2
function SavannahBios.get_global_y_range() end

---@return Vector2
function SavannahBios.get_local_y_range() end

---@return Object
function SavannahBios.debug_monitor_callback() end

---@return Object
function SavannahBios.debug_mux_setup() end

---@return Object
function SavannahBios.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function SavannahBios.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function SavannahBios.drop(impulse) end

function SavannahBios.reset_child_z_index() end

---@param new_state boolean
function SavannahBios.set_autosvc(new_state) end
...
function SavannahBios.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function SavannahBios.get_picker_type(test_picker) end
...
---@param gpos Vector2
function SavannahBios.setup_teleport(gpos) end
