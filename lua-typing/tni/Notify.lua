...
---@param stdout Object
function Notify.get_usage_help(stdout) end

---@param _stdout Object
---@param _args Array<string>
---@return boolean
function Notify.run_with_args(_stdout, _args) end

---@param stdout Object
function Notify.get_usage_help(stdout) end

function Notify.interrupt_shell() end

function Notify.minimize_shell() end
...
function Notify.print_device_inaccessible_error(stdout, deb_addr, dev_addr, device_type) end

---@param stdout Object
---@param dev_addr string
---@param req_type Object
function Notify.print_invalid_device_type(stdout, dev_addr, req_type) end
...
---@param stdout Object
function Notify.print_traversal_context_errors(context, stdout) end

---@param stdout Object
---@param addr Object
function Notify.print_laddr_help(stdout, addr) end

---@param args Array<any>
---@param preposition string
---@return Object
function Notify.parse_preposition_syntax(args, preposition) end
...
---@return Object
function Notify.wrap_termcol(val, fmtspec, colstr, termcol) end

---@param load_last_tick integer
---@param max_load integer
---@return string
function Notify.format_load_string(load_last_tick, max_load) end
