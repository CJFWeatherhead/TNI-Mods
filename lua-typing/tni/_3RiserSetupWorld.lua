...
---@class _3RiserSetupWorld : Node2D
---@field last_tutorial_name string
---@field tutorial_floor0 Object
---@field tutorial_floor1 Object
---@field switch_floor0_addr Object
---@field switch_floor1_addr Object
...
local _3RiserSetupWorld = {}

---@param tutorial_floor Object
---@param guide_node_name Object
---@param old_text Object
---@param new_text Object
function _3RiserSetupWorld.update_guide_text(tutorial_floor, guide_node_name, old_text, new_text) end

function _3RiserSetupWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function _3RiserSetupWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function _3RiserSetupWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function _3RiserSetupWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function _3RiserSetupWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function _3RiserSetupWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function _3RiserSetupWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function _3RiserSetupWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function _3RiserSetupWorld.add_autocomplete_candidate(candid) end

---@param candid string
function _3RiserSetupWorld.remove_autocomplete_candidate(candid) end
...
function _3RiserSetupWorld.add_player(peer_id) end

function _3RiserSetupWorld.try_resume_daycycle() end

function _3RiserSetupWorld.master_timeout() end

function _3RiserSetupWorld.second_elapsed() end

function _3RiserSetupWorld.artifact_timeout() end

---@param peer_id integer
function _3RiserSetupWorld.remove_player(peer_id) end

---@return Object
function _3RiserSetupWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function _3RiserSetupWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function _3RiserSetupWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function _3RiserSetupWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function _3RiserSetupWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function _3RiserSetupWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function _3RiserSetupWorld.sync_pmsg_delta(s_pmsg) end

function _3RiserSetupWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function _3RiserSetupWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function _3RiserSetupWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function _3RiserSetupWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function _3RiserSetupWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function _3RiserSetupWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end
...
function _3RiserSetupWorld.update_server_timescale(timescale_arg) end
...
function _3RiserSetupWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function _3RiserSetupWorld.acquire_all_tech() end
