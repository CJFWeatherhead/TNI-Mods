...
function InertPanel.apply_autoconfig() end

---@param new_pos Vector2
function InertPanel.reposition(new_pos) end
...
---@return Object
function InertPanel.debug_mux_setup() end

---@return Object
function InertPanel.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function InertPanel.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function InertPanel.drop(impulse) end

function InertPanel.reset_child_z_index() end

---@param new_state boolean
function InertPanel.set_autosvc(new_state) end

---@param new_value string
function InertPanel.update_user_note(new_value) end

function InertPanel.remove_and_free_object() end

function InertPanel.reset_child_z_index() end

---@param base_val integer
function InertPanel.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function InertPanel.get_picker_type(test_picker) end
...
---@param gpos Vector2
function InertPanel.setup_teleport(gpos) end
