...
function Ups.set_disp(disptext) end

function Ups.apply_autoconfig() end

---@param new_pos Vector2
function Ups.reposition(new_pos) end

---@param new_pos Vector2
function Ups.elevator_move(new_pos) end

---@return number
function Ups.get_device_bounding_height() end

---@return Vector2
function Ups.get_global_y_range() end

---@return Vector2
function Ups.get_local_y_range() end

---@return Object
function Ups.debug_monitor_callback() end

---@return Object
function Ups.debug_mux_setup() end

---@return Object
function Ups.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function Ups.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function Ups.drop(impulse) end

function Ups.reset_child_z_index() end

---@param new_state boolean
function Ups.set_autosvc(new_state) end

---@param new_value string
function Ups.update_user_note(new_value) end

function Ups.remove_and_free_object() end

function Ups.reset_child_z_index() end

---@param base_val integer
function Ups.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function Ups.get_picker_type(test_picker) end
...
---@param gpos Vector2
function Ups.setup_teleport(gpos) end
