...
---@param stdout Object
---@param d_addr Object
function Route.print_no_dns_server_error(stdout, d_addr) end
...
function Route.print_send_packet_error(stdout, async_send_resultd) end

---@return integer
function Route.get_debugger_pkt_weight() end
...
---@return Object
function Route.send_remote_command(stdout, debugger, node_addr, allow_user_nodes, rc_tc_type, rc_tc_rd, matcher_callback, clear_scrn_after_event) end
