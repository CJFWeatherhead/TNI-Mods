...
local TutorialScenario = {}

function TutorialScenario.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function TutorialScenario.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function TutorialScenario.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function TutorialScenario.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function TutorialScenario.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function TutorialScenario.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function TutorialScenario.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function TutorialScenario.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function TutorialScenario.add_autocomplete_candidate(candid) end

---@param candid string
function TutorialScenario.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function TutorialScenario.get_loc_index(loc) end

---@param sfp string
function TutorialScenario.add_location(sfp) end

---@param peer_id integer
---@return MultiplayerMouse
function TutorialScenario.add_player(peer_id) end

function TutorialScenario.try_resume_daycycle() end

function TutorialScenario.master_timeout() end

function TutorialScenario.second_elapsed() end

function TutorialScenario.artifact_timeout() end

---@param peer_id integer
function TutorialScenario.remove_player(peer_id) end

---@return Object
function TutorialScenario.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function TutorialScenario.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function TutorialScenario.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function TutorialScenario.trigger_game_over(msg, by_force) end

---@param failing_user User
function TutorialScenario.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function TutorialScenario.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function TutorialScenario.sync_pmsg_delta(s_pmsg) end

function TutorialScenario.update_last_node_spawn_ts_now() end

---@param curr_day Object
function TutorialScenario.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function TutorialScenario.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function TutorialScenario.modify_player_cash(amount, details, category) end
...
---@param ppu number
function TutorialScenario.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function TutorialScenario.remove_player_hosting(fqdn) end

---@param fqdn Object
---@param netaddr Object
function TutorialScenario.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function TutorialScenario.update_server_timescale(timescale_arg) end
...
function TutorialScenario.enable_all_listings() end

function TutorialScenario.enable_all_tech_and_listings() end
