...
local DemoAlphaWorld = {}

function DemoAlphaWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function DemoAlphaWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function DemoAlphaWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function DemoAlphaWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function DemoAlphaWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function DemoAlphaWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function DemoAlphaWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function DemoAlphaWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function DemoAlphaWorld.add_autocomplete_candidate(candid) end

---@param candid string
function DemoAlphaWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function DemoAlphaWorld.get_loc_index(loc) end

---@param sfp string
function DemoAlphaWorld.add_location(sfp) end

---@param peer_id integer
---@return MultiplayerMouse
function DemoAlphaWorld.add_player(peer_id) end

function DemoAlphaWorld.try_resume_daycycle() end

function DemoAlphaWorld.master_timeout() end

function DemoAlphaWorld.second_elapsed() end

function DemoAlphaWorld.artifact_timeout() end

---@param peer_id integer
function DemoAlphaWorld.remove_player(peer_id) end

---@return Object
function DemoAlphaWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function DemoAlphaWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function DemoAlphaWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function DemoAlphaWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function DemoAlphaWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function DemoAlphaWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function DemoAlphaWorld.sync_pmsg_delta(s_pmsg) end

function DemoAlphaWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function DemoAlphaWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function DemoAlphaWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function DemoAlphaWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function DemoAlphaWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function DemoAlphaWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function DemoAlphaWorld.remove_player_hosting(fqdn) end

---@param fqdn Object
---@param netaddr Object
function DemoAlphaWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function DemoAlphaWorld.update_server_timescale(timescale_arg) end
...
function DemoAlphaWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function DemoAlphaWorld.acquire_all_tech() end

function DemoAlphaWorld.enable_all_listings() end

function DemoAlphaWorld.enable_all_tech_and_listings() end
