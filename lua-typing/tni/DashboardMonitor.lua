...
local DashboardMonitor = {}

function DashboardMonitor.apply_autoconfig() end

---@param new_pos Vector2
function DashboardMonitor.reposition(new_pos) end
...
---@return Object
function DashboardMonitor.debug_mux_setup() end

---@return Object
function DashboardMonitor.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function DashboardMonitor.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function DashboardMonitor.drop(impulse) end

function DashboardMonitor.reset_child_z_index() end

---@param new_state boolean
function DashboardMonitor.set_autosvc(new_state) end
...
function DashboardMonitor.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function DashboardMonitor.get_picker_type(test_picker) end
...
---@param gpos Vector2
function DashboardMonitor.setup_teleport(gpos) end
