...
---@field locref Location
---@field floor_scene_file_path string
---@field final_date integer
---@field fq_qid integer
local FloorBuildQueueItem = {}
