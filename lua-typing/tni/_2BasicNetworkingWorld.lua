...
---@class _2BasicNetworkingWorld : Node2D
...
local _2BasicNetworkingWorld = {}

function _2BasicNetworkingWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function _2BasicNetworkingWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function _2BasicNetworkingWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function _2BasicNetworkingWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function _2BasicNetworkingWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function _2BasicNetworkingWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function _2BasicNetworkingWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function _2BasicNetworkingWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function _2BasicNetworkingWorld.add_autocomplete_candidate(candid) end

---@param candid string
function _2BasicNetworkingWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function _2BasicNetworkingWorld.get_loc_index(loc) end

---@param sfp string
function _2BasicNetworkingWorld.add_location(sfp) end

---@param peer_id integer
---@return MultiplayerMouse
function _2BasicNetworkingWorld.add_player(peer_id) end

function _2BasicNetworkingWorld.try_resume_daycycle() end

function _2BasicNetworkingWorld.master_timeout() end

function _2BasicNetworkingWorld.second_elapsed() end

function _2BasicNetworkingWorld.artifact_timeout() end

---@param peer_id integer
function _2BasicNetworkingWorld.remove_player(peer_id) end

---@return Object
function _2BasicNetworkingWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function _2BasicNetworkingWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function _2BasicNetworkingWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function _2BasicNetworkingWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function _2BasicNetworkingWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function _2BasicNetworkingWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function _2BasicNetworkingWorld.sync_pmsg_delta(s_pmsg) end

function _2BasicNetworkingWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function _2BasicNetworkingWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function _2BasicNetworkingWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function _2BasicNetworkingWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function _2BasicNetworkingWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function _2BasicNetworkingWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function _2BasicNetworkingWorld.remove_player_hosting(fqdn) end

---@param fqdn Object
---@param netaddr Object
function _2BasicNetworkingWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function _2BasicNetworkingWorld.update_server_timescale(timescale_arg) end
...
function _2BasicNetworkingWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function _2BasicNetworkingWorld.acquire_all_tech() end

function _2BasicNetworkingWorld.enable_all_listings() end

function _2BasicNetworkingWorld.enable_all_tech_and_listings() end
