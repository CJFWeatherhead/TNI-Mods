...
---@field mouse_in_area boolean
---@field panel_connected boolean
---@field start_panel PatchPanel
---@field end_panel PatchPanel
...
function PatchPanel.connect_patch_panel_link() end

function PatchPanel.finish_cable_connection() end

---@return PatchPanel
function PatchPanel.get_panel_at_mouse() end

function PatchPanel.apply_autoconfig() end

---@param new_pos Vector2
function PatchPanel.reposition(new_pos) end

---@param new_pos Vector2
function PatchPanel.elevator_move(new_pos) end

---@return number
function PatchPanel.get_device_bounding_height() end

---@return Vector2
function PatchPanel.get_global_y_range() end

---@return Vector2
function PatchPanel.get_local_y_range() end

---@return Object
function PatchPanel.debug_monitor_callback() end

---@return Object
function PatchPanel.debug_mux_setup() end

---@return Object
function PatchPanel.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function PatchPanel.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function PatchPanel.drop(impulse) end

function PatchPanel.reset_child_z_index() end

---@param new_state boolean
function PatchPanel.set_autosvc(new_state) end

---@param new_value string
function PatchPanel.update_user_note(new_value) end

function PatchPanel.remove_and_free_object() end

function PatchPanel.reset_child_z_index() end

---@param base_val integer
function PatchPanel.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function PatchPanel.get_picker_type(test_picker) end
...
---@param gpos Vector2
function PatchPanel.setup_teleport(gpos) end
