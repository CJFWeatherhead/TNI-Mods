...
function CnetworkWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function CnetworkWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function CnetworkWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function CnetworkWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function CnetworkWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function CnetworkWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function CnetworkWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function CnetworkWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function CnetworkWorld.add_autocomplete_candidate(candid) end

---@param candid string
function CnetworkWorld.remove_autocomplete_candidate(candid) end
...
function CnetworkWorld.add_player(peer_id) end

function CnetworkWorld.try_resume_daycycle() end

function CnetworkWorld.master_timeout() end

function CnetworkWorld.second_elapsed() end

function CnetworkWorld.artifact_timeout() end

---@param peer_id integer
function CnetworkWorld.remove_player(peer_id) end

---@return Object
function CnetworkWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function CnetworkWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function CnetworkWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function CnetworkWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function CnetworkWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function CnetworkWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function CnetworkWorld.sync_pmsg_delta(s_pmsg) end

function CnetworkWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function CnetworkWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function CnetworkWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function CnetworkWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function CnetworkWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function CnetworkWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end
...
function CnetworkWorld.update_server_timescale(timescale_arg) end
...
function CnetworkWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function CnetworkWorld.acquire_all_tech() end
