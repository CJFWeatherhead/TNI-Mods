...
function PowerManagement.apply_mod() end

function PowerManagement.activate_local_effects() end

---@return string
function PowerManagement.get_proposal_name() end

---@return string
function PowerManagement.get_lore() end

---@return string
function PowerManagement.get_description() end

---@return Object
function PowerManagement.test_adhoc_requirements() end

---@return Object
function PowerManagement.test_adhoc_requirements() end

function PowerManagement.submit_and_apply() end

function PowerManagement.update_state() end
