...
local EndlessBetaWorld = {}

function EndlessBetaWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function EndlessBetaWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function EndlessBetaWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function EndlessBetaWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function EndlessBetaWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function EndlessBetaWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function EndlessBetaWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function EndlessBetaWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function EndlessBetaWorld.add_autocomplete_candidate(candid) end

---@param candid string
function EndlessBetaWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function EndlessBetaWorld.get_loc_index(loc) end

---@param sfp string
function EndlessBetaWorld.add_location(sfp) end

---@param peer_id integer
---@return MultiplayerMouse
function EndlessBetaWorld.add_player(peer_id) end

function EndlessBetaWorld.try_resume_daycycle() end

function EndlessBetaWorld.master_timeout() end

function EndlessBetaWorld.second_elapsed() end

function EndlessBetaWorld.artifact_timeout() end

---@param peer_id integer
function EndlessBetaWorld.remove_player(peer_id) end

---@return Object
function EndlessBetaWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function EndlessBetaWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function EndlessBetaWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function EndlessBetaWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function EndlessBetaWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function EndlessBetaWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function EndlessBetaWorld.sync_pmsg_delta(s_pmsg) end

function EndlessBetaWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function EndlessBetaWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function EndlessBetaWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function EndlessBetaWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function EndlessBetaWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function EndlessBetaWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function EndlessBetaWorld.remove_player_hosting(fqdn) end

---@param fqdn Object
---@param netaddr Object
function EndlessBetaWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function EndlessBetaWorld.update_server_timescale(timescale_arg) end
...
function EndlessBetaWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function EndlessBetaWorld.acquire_all_tech() end

function EndlessBetaWorld.enable_all_listings() end

function EndlessBetaWorld.enable_all_tech_and_listings() end
