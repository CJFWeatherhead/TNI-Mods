...
local EndlessBetaFixedSeedWorld = {}

function EndlessBetaFixedSeedWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function EndlessBetaFixedSeedWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function EndlessBetaFixedSeedWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function EndlessBetaFixedSeedWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function EndlessBetaFixedSeedWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function EndlessBetaFixedSeedWorld.test_merchant_existence(merchant_sfp) end
...
---@param candid string
function EndlessBetaFixedSeedWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function EndlessBetaFixedSeedWorld.get_loc_index(loc) end

---@param sfp string
function EndlessBetaFixedSeedWorld.add_location(sfp) end

---@param peer_id integer
---@return MultiplayerMouse
function EndlessBetaFixedSeedWorld.add_player(peer_id) end

function EndlessBetaFixedSeedWorld.try_resume_daycycle() end

function EndlessBetaFixedSeedWorld.master_timeout() end

function EndlessBetaFixedSeedWorld.second_elapsed() end

function EndlessBetaFixedSeedWorld.artifact_timeout() end

---@param peer_id integer
function EndlessBetaFixedSeedWorld.remove_player(peer_id) end

---@return Object
function EndlessBetaFixedSeedWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function EndlessBetaFixedSeedWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function EndlessBetaFixedSeedWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function EndlessBetaFixedSeedWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function EndlessBetaFixedSeedWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function EndlessBetaFixedSeedWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function EndlessBetaFixedSeedWorld.sync_pmsg_delta(s_pmsg) end

function EndlessBetaFixedSeedWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function EndlessBetaFixedSeedWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function EndlessBetaFixedSeedWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function EndlessBetaFixedSeedWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function EndlessBetaFixedSeedWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function EndlessBetaFixedSeedWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function EndlessBetaFixedSeedWorld.remove_player_hosting(fqdn) end

---@param fqdn Object
---@param netaddr Object
function EndlessBetaFixedSeedWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function EndlessBetaFixedSeedWorld.update_server_timescale(timescale_arg) end
...
function EndlessBetaFixedSeedWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function EndlessBetaFixedSeedWorld.acquire_all_tech() end

function EndlessBetaFixedSeedWorld.enable_all_listings() end

function EndlessBetaFixedSeedWorld.enable_all_tech_and_listings() end
