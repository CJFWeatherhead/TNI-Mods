...
local CompanyDatacenterWorld = {}

function CompanyDatacenterWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function CompanyDatacenterWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function CompanyDatacenterWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function CompanyDatacenterWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function CompanyDatacenterWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function CompanyDatacenterWorld.test_merchant_existence(merchant_sfp) end
...
---@param candid string
function CompanyDatacenterWorld.remove_autocomplete_candidate(candid) end
...
function CompanyDatacenterWorld.add_player(peer_id) end

function CompanyDatacenterWorld.try_resume_daycycle() end

function CompanyDatacenterWorld.master_timeout() end

function CompanyDatacenterWorld.second_elapsed() end

function CompanyDatacenterWorld.artifact_timeout() end

---@param peer_id integer
function CompanyDatacenterWorld.remove_player(peer_id) end

---@return Object
function CompanyDatacenterWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function CompanyDatacenterWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function CompanyDatacenterWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function CompanyDatacenterWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function CompanyDatacenterWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function CompanyDatacenterWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function CompanyDatacenterWorld.sync_pmsg_delta(s_pmsg) end

function CompanyDatacenterWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function CompanyDatacenterWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function CompanyDatacenterWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function CompanyDatacenterWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function CompanyDatacenterWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function CompanyDatacenterWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end
...
function CompanyDatacenterWorld.update_server_timescale(timescale_arg) end
...
function CompanyDatacenterWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function CompanyDatacenterWorld.acquire_all_tech() end
