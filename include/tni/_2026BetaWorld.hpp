...
struct _2026BetaWorld : public Node2D {
	using Node2D::Node2D;

	constexpr _2026BetaWorld(Node2D base) : Node2D{base} {}
	constexpr _2026BetaWorld(uint64_t addr) : Node2D{addr} {}
	constexpr _2026BetaWorld(Object obj) : _2026BetaWorld{obj.address()} {}
	_2026BetaWorld(Variant variant) : _2026BetaWorld{variant.as_object().address()} {}
...
inline void _2026BetaWorld::recompute_diff_hash() { voidcall("recompute_diff_hash"); }
inline void _2026BetaWorld::update_player_msg(Variant msg_id, GameMessage gm) { voidcall("update_player_msg", msg_id, gm); }
inline Variant _2026BetaWorld::get_player_msg(Variant msg_id) { return operator()("get_player_msg", msg_id); }
inline Variant _2026BetaWorld::get_transactional_sum(Variant n_date, Variant count_map) { return operator()("get_transactional_sum", n_date, count_map); }
...
inline void _2026BetaWorld::add_location(String sfp) { voidcall("add_location", sfp); }
inline MultiplayerMouse _2026BetaWorld::add_player(int64_t peer_id) { return MultiplayerMouse(operator()("add_player", peer_id).as_object().address()); }
inline void _2026BetaWorld::try_resume_daycycle() { voidcall("try_resume_daycycle"); }
inline void _2026BetaWorld::master_timeout() { voidcall("master_timeout"); }
inline void _2026BetaWorld::second_elapsed() { voidcall("second_elapsed"); }
inline void _2026BetaWorld::artifact_timeout() { voidcall("artifact_timeout"); }
inline void _2026BetaWorld::remove_player(int64_t peer_id) { voidcall("remove_player", peer_id); }
inline Variant _2026BetaWorld::debug_monitor_callback() { return operator()("debug_monitor_callback"); }
inline Variant _2026BetaWorld::calculate_payment_due_breakdown(bool itemized) { return operator()("calculate_payment_due_breakdown", itemized); }
inline Variant _2026BetaWorld::get_full_savepath(String subname) { return operator()("get_full_savepath", subname); }
inline void _2026BetaWorld::trigger_game_over(Variant msg, bool by_force) { voidcall("trigger_game_over", msg, by_force); }
inline void _2026BetaWorld::submit_user_complaint(User failing_user) { voidcall("submit_user_complaint", failing_user); }
inline void _2026BetaWorld::sync_ptrans_delta(Variant s_ptrans) { voidcall("sync_ptrans_delta", s_ptrans); }
inline void _2026BetaWorld::sync_pmsg_delta(Variant s_pmsg) { voidcall("sync_pmsg_delta", s_pmsg); }
inline void _2026BetaWorld::update_last_node_spawn_ts_now() { voidcall("update_last_node_spawn_ts_now"); }
inline void _2026BetaWorld::trigger_day_elapse(Variant curr_day) { voidcall("trigger_day_elapse", curr_day); }
inline void _2026BetaWorld::acquire_app_license(String title, int64_t license_cost) { voidcall("acquire_app_license", title, license_cost); }
inline void _2026BetaWorld::modify_player_cash(Variant amount, Variant details, int64_t category) { voidcall("modify_player_cash", amount, details, category); }
inline void _2026BetaWorld::send_player_message(Variant title, Variant msg, int64_t tone_enum) { voidcall("send_player_message", title, msg, tone_enum); }
inline void _2026BetaWorld::add_player_hosting(String fqdn, String use_spec_csv, double ppu) { voidcall("add_player_hosting", fqdn, use_spec_csv, ppu); }
inline void _2026BetaWorld::remove_player_hosting(String fqdn) { voidcall("remove_player_hosting", fqdn); }
inline void _2026BetaWorld::put_dns_entry(Variant fqdn, Variant netaddr) { voidcall("put_dns_entry", fqdn, netaddr); }
inline void _2026BetaWorld::update_server_timescale(double timescale_arg) { voidcall("update_server_timescale", timescale_arg); }
inline void _2026BetaWorld::submit_alert_with_lowpass(String normal_alert_title, String normal_alert_full_msg, String lowpass_alert_title, String lowpass_alert_full_msg) { voidcall("submit_alert_with_lowpass", normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg); }
inline void _2026BetaWorld::acquire_all_tech() { voidcall("acquire_all_tech"); }
inline void _2026BetaWorld::enable_all_listings() { voidcall("enable_all_listings"); }
inline void _2026BetaWorld::enable_all_tech_and_listings() { voidcall("enable_all_tech_and_listings"); }
