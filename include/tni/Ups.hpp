...
inline double Ups::get_device_bounding_height() { return operator()("get_device_bounding_height"); }
inline Variant Ups::get_global_y_range() { return operator()("get_global_y_range"); }
inline Variant Ups::get_local_y_range() { return operator()("get_local_y_range"); }
