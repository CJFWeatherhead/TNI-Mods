...
inline void RoutinesPower::print_no_dns_server_error(Variant stdout_, Variant d_addr) { voidcall("print_no_dns_server_error", stdout_, d_addr); }
...
inline void RoutinesPower::print_send_packet_error(Variant stdout_, Variant async_send_resultd) { voidcall("print_send_packet_error", stdout_, async_send_resultd); }
inline int64_t RoutinesPower::get_debugger_pkt_weight() { return operator()("get_debugger_pkt_weight"); }
